...
# Thứ tự xoay vòng: Thành, Khanh, Nguyễn Hoàng Kha đã làm rồi (tính đến 2026-07-17)
# nên dồn xuống cuối, người chưa làm lên trước.
STYLISTS = [
    "Võ Văn Trí",
    "Phạm Văn Phát",
    "Huỳnh Văn Kha",
...
# Nguyễn Thị Thúy Hằng đã làm rồi (tính đến 2026-07-17) nên dồn xuống cuối.
SKINNERS = [
    "Nguyễn Thị Kim Ngân",
    "Ngô Thị Ngọc Ánh",
...
# Cặp của mỗi ngày cố định theo vị trí trong danh sách, neo từ hôm nay -
# không đổi trong ngày dù 1 trong 2 người đã nộp bài trước.
SCHEDULE_ANCHOR = date(2026, 7, 18)
...
def posted_set(rows):
    """Tập (date, name) đã có link nộp - dùng để đánh dấu trạng thái, không
    dùng để đổi cặp của ngày đó."""
        ...
        out.append(
            {
                "date": iso,
                "stylist": stylist,
                "stylist_done": (iso, stylist) in done,
                "skinner": skinner,
                "skinner_done": (iso, skinner) in done,
            }
        )
    return out
